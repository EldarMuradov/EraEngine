...
EEXTERN ERASCRIPTINGCPPDECLS_API enative_scripting_builder* createNativeScriptingBuilder(void) noexcept;
...
// Debug
EEXTERN ERASCRIPTINGCPPDECLS_API void log_message(uint8_t mode, const char* message) noexcept;
