...
union wN_vec2
{
	...
	static wN_vec2 NODISCARD zero() { return wN_vec2<simd_t>(simd_t::zero()); }
};
...
union wN_vec3
{
	...
	static NODISCARD wN_vec3 zero() { return wN_vec3<simd_t>(simd_t::zero()); }
};
...
union wN_vec4
{
	...
	static wN_vec4 NODISCARD zero() { return wN_vec4<simd_t>(simd_t::zero()); }
};
...
union wN_quat
{
	...
	static wN_quat NODISCARD identity() { return wN_quat<simd_t>(simd_t::zero(), simd_t::zero(), simd_t::zero(), simd_t(1.f)); }
};
...
// Vec2 operators.
template <typename simd_t> inline wN_vec2<simd_t> operator+(wN_vec2<simd_t> a, wN_vec2<simd_t> b) { wN_vec2 result = { a.x + b.x, a.y + b.y }; return result; }
template <typename simd_t> inline wN_vec2<simd_t>& operator+=(wN_vec2<simd_t>& a, wN_vec2<simd_t> b) { a = a + b; return a; }
template <typename simd_t> inline wN_vec2<simd_t> operator-(wN_vec2<simd_t> a, wN_vec2<simd_t> b) { wN_vec2 result = { a.x - b.x, a.y - b.y }; return result; }
template <typename simd_t> inline wN_vec2<simd_t>& operator-=(wN_vec2<simd_t>& a, wN_vec2<simd_t> b) { a = a - b; return a; }
template <typename simd_t> inline wN_vec2<simd_t> operator*(wN_vec2<simd_t> a, wN_vec2<simd_t> b) { wN_vec2 result = { a.x * b.x, a.y * b.y }; return result; }
template <typename simd_t> inline wN_vec2<simd_t>& operator*=(wN_vec2<simd_t>& a, wN_vec2<simd_t> b) { a = a * b; return a; }
...
template <typename simd_t> inline wN_vec2<simd_t> operator*(wN_vec2<simd_t> a, simd_t b) { wN_vec2 result = { a.x * b, a.y * b }; return result; }
template <typename simd_t> inline wN_vec2<simd_t> operator*(simd_t a, wN_vec2<simd_t> b) { return b * a; }
template <typename simd_t> inline wN_vec2<simd_t>& operator*=(wN_vec2<simd_t>& a, simd_t b) { a = a * b; return a; }
template <typename simd_t> inline wN_vec2<simd_t> operator/(wN_vec2<simd_t> a, simd_t b) { wN_vec2 result = { a.x / b, a.y / b }; return result; }
template <typename simd_t> inline wN_vec2<simd_t>& operator/=(wN_vec2<simd_t>& a, simd_t b) { a = a / b; return a; }

template <typename simd_t> inline wN_vec2<simd_t> operator-(wN_vec2<simd_t> a) { return wN_vec2(-a.x, -a.y); }

template <typename simd_t> inline auto operator==(wN_vec2<simd_t> a, wN_vec2<simd_t> b) { return a.x == b.x & a.y == b.y; }

// Vec3 operators.
template <typename simd_t> inline wN_vec3<simd_t> operator+(wN_vec3<simd_t> a, wN_vec3<simd_t> b) { wN_vec3 result = { a.x + b.x, a.y + b.y, a.z + b.z }; return result; }
template <typename simd_t> inline wN_vec3<simd_t>& operator+=(wN_vec3<simd_t>& a, wN_vec3<simd_t> b) { a = a + b; return a; }
template <typename simd_t> inline wN_vec3<simd_t> operator-(wN_vec3<simd_t> a, wN_vec3<simd_t> b) { wN_vec3 result = { a.x - b.x, a.y - b.y, a.z - b.z }; return result; }
template <typename simd_t> inline wN_vec3<simd_t>& operator-=(wN_vec3<simd_t>& a, wN_vec3<simd_t> b) { a = a - b; return a; }
template <typename simd_t> inline wN_vec3<simd_t> operator*(wN_vec3<simd_t> a, wN_vec3<simd_t> b) { wN_vec3 result = { a.x * b.x, a.y * b.y, a.z * b.z }; return result; }
template <typename simd_t> inline wN_vec3<simd_t>& operator*=(wN_vec3<simd_t>& a, wN_vec3<simd_t> b) { a = a * b; return a; }
...
template <typename simd_t> inline wN_vec3<simd_t> operator*(wN_vec3<simd_t> a, simd_t b) { wN_vec3 result = { a.x * b, a.y * b, a.z * b }; return result; }
template <typename simd_t> inline wN_vec3<simd_t> operator*(simd_t a, wN_vec3<simd_t> b) { return b * a; }
template <typename simd_t> inline wN_vec3<simd_t>& operator*=(wN_vec3<simd_t>& a, simd_t b) { a = a * b; return a; }
template <typename simd_t> inline wN_vec3<simd_t> operator/(wN_vec3<simd_t> a, simd_t b) { wN_vec3 result = { a.x / b, a.y / b, a.z / b }; return result; }
template <typename simd_t> inline wN_vec3<simd_t>& operator/=(wN_vec3<simd_t>& a, simd_t b) { a = a / b; return a; }

template <typename simd_t> inline wN_vec3<simd_t> operator-(wN_vec3<simd_t> a) { return wN_vec3(-a.x, -a.y, -a.z); }

template <typename simd_t> inline auto operator==(wN_vec3<simd_t> a, wN_vec3<simd_t> b) { return a.x == b.x & a.y == b.y & a.z == b.z; }

// Vec4 operators.
template <typename simd_t> inline wN_vec4<simd_t> operator+(wN_vec4<simd_t> a, wN_vec4<simd_t> b) { wN_vec4 result = { a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w }; return result; }
template <typename simd_t> inline wN_vec4<simd_t>& operator+=(wN_vec4<simd_t>& a, wN_vec4<simd_t> b) { a = a + b; return a; }
template <typename simd_t> inline wN_vec4<simd_t> operator-(wN_vec4<simd_t> a, wN_vec4<simd_t> b) { wN_vec4 result = { a.x - b.x, a.y - b.y, a.z - b.z, a.w - b.w }; return result; }
template <typename simd_t> inline wN_vec4<simd_t>& operator-=(wN_vec4<simd_t>& a, wN_vec4<simd_t> b) { a = a - b; return a; }
template <typename simd_t> inline wN_vec4<simd_t> operator*(wN_vec4<simd_t> a, wN_vec4<simd_t> b) { wN_vec4 result = { a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w }; return result; }
template <typename simd_t> inline wN_vec4<simd_t>& operator*=(wN_vec4<simd_t>& a, wN_vec4<simd_t> b) { a = a * b; return a; }
...
template <typename simd_t> inline wN_vec4<simd_t> operator*(wN_vec4<simd_t> a, simd_t b) { wN_vec4 result = { a.x * b, a.y * b, a.z * b, a.w * b }; return result; }
template <typename simd_t> inline wN_vec4<simd_t> operator*(simd_t a, wN_vec4<simd_t> b) { return b * a; }
template <typename simd_t> inline wN_vec4<simd_t>& operator*=(wN_vec4<simd_t>& a, simd_t b) { a = a * b; return a; }
template <typename simd_t> inline wN_vec4<simd_t> operator/(wN_vec4<simd_t> a, simd_t b) { wN_vec4 result = { a.x / b, a.y / b, a.z / b, a.w / b }; return result; }
template <typename simd_t> inline wN_vec4<simd_t>& operator/=(wN_vec4<simd_t>& a, simd_t b) { a = a / b; return a; }

template <typename simd_t> inline wN_vec4<simd_t> operator-(wN_vec4<simd_t> a) { return wN_vec4(-a.x, -a.y, -a.z, -a.w); }

template <typename simd_t> inline auto operator==(wN_vec4<simd_t> a, wN_vec4<simd_t> b) { return a.x == b.x & a.y == b.y & a.z == b.z & a.w == b.w; }

template <typename simd_t> inline simd_t dot(wN_vec2<simd_t> a, wN_vec2<simd_t> b) { simd_t result = fmadd(a.x, b.x, a.y * b.y); return result; }
template <typename simd_t> inline simd_t dot(wN_vec3<simd_t> a, wN_vec3<simd_t> b) { simd_t result = fmadd(a.x, b.x, fmadd(a.y, b.y, a.z * b.z)); return result; }
template <typename simd_t> inline simd_t dot(wN_vec4<simd_t> a, wN_vec4<simd_t> b) { simd_t result = fmadd(a.x, b.x, fmadd(a.y, b.y, fmadd(a.z, b.z, a.w * b.w))); return result; }
...
template <typename simd_t>
inline wN_quat<simd_t> operator*(wN_quat<simd_t> a, wN_quat<simd_t> b)
{
...
template <typename simd_t> inline wN_quat<simd_t> operator*(wN_quat<simd_t> q, simd_t s) { wN_quat result; result.v4 = q.v4 * s;	return result; }
template <typename simd_t> inline wN_vec3<simd_t> operator*(wN_quat<simd_t> q, wN_vec3<simd_t> v) { wN_quat p(v.x, v.y, v.z, simd_t::zero()); return (q * p * conjugate(q)).v; }

template <typename simd_t> inline auto operator==(wN_quat<simd_t> a, wN_quat<simd_t> b) { return a.x == b.x & a.y == b.y & a.z == b.z & a.w == b.w; }

template <typename simd_t> inline NODISCARD wN_vec2<simd_t> lerp(wN_vec2<simd_t> l, wN_vec2<simd_t> u, simd_t t) { return fmadd(wN_vec2<simd_t>(t), u - l, l); }
template <typename simd_t> inline NODISCARD wN_vec3<simd_t> lerp(wN_vec3<simd_t> l, wN_vec3<simd_t> u, simd_t t) { return fmadd(wN_vec3<simd_t>(t), u - l, l); }
template <typename simd_t> inline NODISCARD wN_vec4<simd_t> lerp(wN_vec4<simd_t> l, wN_vec4<simd_t> u, simd_t t) { return fmadd(wN_vec4<simd_t>(t), u - l, l); }
template <typename simd_t> inline NODISCARD wN_quat<simd_t> lerp(wN_quat<simd_t> l, wN_quat<simd_t> u, simd_t t) { wN_quat result; result.v4 = lerp(l.v4, u.v4, t); return normalize(result); }
...
template <typename simd_t>
inline wN_vec3<simd_t> operator*(const wN_mat3<simd_t>& a, wN_vec3<simd_t> b)
{
...
template <typename simd_t>
inline wN_vec4<simd_t> operator*(const wN_mat4<simd_t>& a, wN_vec4<simd_t> b)
{
...
template <typename simd_t>
inline wN_mat2<simd_t> operator*(const wN_mat2<simd_t>& a, const wN_mat2<simd_t>& b)
{
...
template <typename simd_t>
inline wN_mat3<simd_t> operator*(const wN_mat3<simd_t>& a, const wN_mat3<simd_t>& b)
{
...
template <typename simd_t>
inline wN_mat4<simd_t> operator*(const wN_mat4<simd_t>& a, const wN_mat4<simd_t>& b)
{
...
template <typename simd_t>
NODISCARD inline wN_mat3<simd_t> transpose(const wN_mat3<simd_t>& a)
{
	wN_mat3<simd_t> result;
...
template <typename simd_t>
NODISCARD inline wN_mat4<simd_t> transpose(const wN_mat4<simd_t>& a)
{
	wN_mat4<simd_t> result;
