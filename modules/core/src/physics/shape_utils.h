...
namespace era_engine::physics
{
	...
	class ShapeUtils final
	{
		ShapeUtils() = delete;
	public:
		static physx::PxConvexMesh* build_convex_mesh(const mesh_asset* asset, const vec3& size);
		static physx::PxTriangleMesh* build_triangle_mesh(const mesh_asset* asset, const vec3& size);
