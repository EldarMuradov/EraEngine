...
{
	physx::PxConvexMesh* ShapeUtils::build_convex_mesh(const mesh_asset* asset, const vec3& size)
	{
	...
	physx::PxTriangleMesh* ShapeUtils::build_triangle_mesh(const mesh_asset* asset, const vec3& size)
	{
		using namespace physx;
		...
		PxVec3 physics_model_size = createPxVec3(size);
