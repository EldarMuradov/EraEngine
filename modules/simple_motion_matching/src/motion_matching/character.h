...
namespace era_engine
{
    ...
    struct ERA_MOTION_MATCHING_API character
    {
    ...
    static void character_load(character& c, const char* filename)
    {
    ...
    static void linear_blend_skinning_positions(
    ...
    static void linear_blend_skinning_normals(
